...
CREATE TABLE "workspaces" (
	...
	"image" text DEFAULT 'notea/workspace:dev' NOT NULL,
	"resources" jsonb,
	"repo_url" text,
...
CREATE INDEX "workspace_events_ws_idx" ON "workspace_events" USING btree ("workspace_id","id");--> statement-breakpoint
